...
import Frontpost from "../../src/components/Frontpost.js";
...
describe("Frontpage", () => {
  ...
  describe("Frontpost", () => {
    it("renders title and abstract of a frontpost", () => {
      ...
      const component = renderIntoDocument(React.createElement(Frontpost, postData));
    ...
    it("shows the days since the post date", () => {
      ...
      const delay = Math.floor((today - postDate) / 3600000)
